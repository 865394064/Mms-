...
import android.widget.Button;//added by xiashuaishuai on 20150116 for Bug[3294]
...
public class MmsPlayerActivity extends Activity implements Contact.UpdateListener, IMmsTextSizeAdjustHost {
    ...
    private Button mBackButton;//added by xiashuaishuai on 20150116 for Bug[3294]
    ...
    public void onCreate(Bundle icicle) {
        ...
        //Begin:added by xiashuaishuai on 20150116 for Bug[3294]
        mBackButton=(Button)findViewById(R.id.back_to_slideshow_edit);
        mBackButton.setOnClickListener(new OnClickListener(){
            public void onClick(View v) {
                finish();
            }
         });
        //End:added by xiashuaishuai on 20150116 for Bug[3294]
    ...
    protected void onStart() {
        ...
        /**begin: del by lzp for bug [2508]
         */
        /*ActionBar actionBar = getActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle(R.string.mms);*/
        /**End: del by lzp for bug [2508]
         */
