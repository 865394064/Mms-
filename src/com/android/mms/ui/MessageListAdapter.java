...
import com.android.mms.ui.MessageListItem.SelectMessageNumberListener;
/**
...
//                            }
	     ...
	     ((MessageListItem) view).setSelectMessageNumberListener(mListener);
        }
   ...
   public void setSelectMessageNumberListener(SelectMessageNumberListener listener){
    ...
    public void changeSelectedState(long listId) {
        if(mListItem != null && mListItem.get(listId) != null)//added by lzp
