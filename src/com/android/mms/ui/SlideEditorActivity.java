...
public class SlideEditorActivity extends Activity implements IMmsTextSizeAdjustHost{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		//Begin : added by xiashuaishuai on 20150304			
		...
		//End : added by xiashuaishuai on 20150304		
                break;
            ...
            case MENU_RECORD_SOUND:
                ...
                /// let recorder auto stop when the messaging reach limit @{
                 sizeLimit = ComposeMessageActivity.computeAttachmentSizeLimitForAppen(mSlideshowModel);//mody by xiashuaishuai on 20150304
            ...
            case MENU_TAKE_VIDEO:
                slide = mSlideshowModel.get(mPosition);
                currentSlideSize = slide.getSlideSize();//mody by xiashuaishuai on 20150304
