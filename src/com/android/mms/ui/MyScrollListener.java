...
public class MyScrollListener implements OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
    	...
    	if(view.getAdapter() instanceof HeaderViewListAdapter) {
	    	HeaderViewListAdapter listAdapter=(HeaderViewListAdapter)view.getAdapter();
			mlistAdapter = (MessageCursorAdapter) listAdapter.getWrappedAdapter();
    	} else {
    		mlistAdapter = (MessageCursorAdapter) view.getAdapter();
    	}

        //MessageCursorAdapter mlistAdapter = (MessageCursorAdapter) view.getAdapter();//removed by wang 20130328
