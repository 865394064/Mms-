...
import com.android.mms.ui.ConversationList.MyDeleteItemOfSmsListListener;
/**
...
public class ConversationListAdapter extends MessageCursorAdapter implements AbsListView.RecyclerListener {
    ...
    private MyDeleteItemOfSmsListListener mListener;
    ...
    public ConversationListAdapter(MyDeleteItemOfSmsListListener listener, Context context, Cursor cursor) {
         super(context, cursor, false /* auto-requery */);
        mFactory = LayoutInflater.from(context);
	 mListener = listener;
    }
	...
	headerView.setDeleteItemOfSmsListListener(mListener);
        /// @}
    /**begin:add by csc for debug 2932**/
	if (flag==true)
	{
		headerView.changeStateToEdit1();
	}else{
		headerView.changeStateToComplete1();
	}
    /**end:add by csc for debug 2932**/
    }
