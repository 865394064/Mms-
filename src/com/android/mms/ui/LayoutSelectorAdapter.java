    ...
    protected static List<IconListItem> getData(Context context) {
        List<IconListItem> data = new ArrayList<IconListItem>(2);
         addItem(data, context.getString(R.string.select_top_text)/**,
                R.drawable.ic_mms_text_top**/);//Mody by xiashuaishuai 20141218 for Bug[3294]
         addItem(data, context.getString(R.string.select_bottom_text)/**,
                R.drawable.ic_mms_text_bottom**/);//Mody by xiashuaishuai 20141218 for Bug[3294]

        return data;
    }

    protected static void addItem(List<IconListItem> data, String title/**, int resource**/) {//Mody by xiashuaishuai 20141218 for Bug[3294]
        IconListItem temp = new IconListItem(title/**, resource**/);//Mody by xiashuaishuai 20141218 for Bug[3294]
        data.add(temp);
    }
}
